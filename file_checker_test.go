...
func TestFileCheckerCheck(t *testing.T) {
	c := newFileChecker(0, "", nil, false, false, false, false, newSemaphore(1024))
...
func TestFileCheckerCheckMany(t *testing.T) {
	c := newFileChecker(0, "", nil, false, false, false, false, newSemaphore(maxOpenFiles))
...
func TestFileCheckerExtractURLs(t *testing.T) {
	c := newFileChecker(0, "", nil, false, false, false, false, newSemaphore(42))
